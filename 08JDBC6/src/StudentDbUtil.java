...
public class StudentDbUtil {
	...
	public List<Student> searchStudents(String theSearchName) throws Exception
	{
		...
		try
		{
			...
			{
				//Create SQL to search for students by name to make search case sensitive: lower(...)
			...
			{
				//create SQL to get all students in the case that the search does not return any results. 
				//This will re-populate the table with the database information
				String sql = "select * from student order by last_name";
			...
			while(myRs.next())
			{
				//Retrieve data from result set row from id, first_name, last_name, and email in database
				int id = myRs.getInt("id");
				String firstName = myRs.getString("first_name");
				String lastName = myRs.getString("last_name");
				String email = myRs.getString("email");
				...
				//Add object to list of students
				students.add(tempStudent);
			}
